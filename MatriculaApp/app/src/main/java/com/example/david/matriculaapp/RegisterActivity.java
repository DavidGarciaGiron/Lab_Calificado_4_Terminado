...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detalleInput=findViewById(R.id.detalle_input);
    }
    ...
    public void callRegister(View view) {
        ...
        if (tipo.isEmpty() || correo.isEmpty()) {
            Toast.makeText(this, "Tipo y Correo son campos requeridos", Toast.LENGTH_SHORT).show();
            return;
        }

        ApiService service = ApiServiceGenerator.createService(ApiService.class);

        Call<Persona> call = null;

        if (mediaFileUri == null) {
            // Si no se incluye imagen hacemos un envío POST simple
            call = service.createPersona(tipo, correo, detalle);
        } else {
            ...
            RequestBody detallePart = RequestBody.create(MultipartBody.FORM, detalle);

            call = service.createPersonaWithImage(tipoPart, correoPart, detallePart, imagenPart);
        }
            ...
            public void onResponse(Call<Persona> call, Response<Persona> response) {
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        Toast.makeText(RegisterActivity.this, "Registro satisfactorio", Toast.LENGTH_LONG).show();
                        finish();
